...
public class LancamentoServiceTest {
	...
	public void setUp() {
		...
		BDDMockito.given(this.lancamentoRepository.findById(Mockito.anyLong())).willReturn(Mockito.any());
	...
	public void testBuscarLancamentoPorFuncionarioId() {
		Page<Lancamento> lancamento = this.lancamentoService.buscarFuncionarioId(1L, new PageRequest(0, 10));
